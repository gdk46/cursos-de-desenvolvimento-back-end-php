...
class AdminController
{
    ...
    public function insert()
    {
        try {
            ...
            echo '<script>location.href="?page=admin&metodo=index"</script>';
        } catch (Exception $e) {
            echo '<script>alert("' . $e->getMessage() . '");</script>';
            echo '<script>location.href="?page=admin&metodo=create"</script>';
        }
    }
    ...
    public function update()
    {
        try {
            ...
            echo '<script>alert("' . $e->getMessage() . '");</script>';
            echo '<script>location.href="?page=admin&metodo=change&id=' . $_POST['id'] . '"</script>';
        }
    }
